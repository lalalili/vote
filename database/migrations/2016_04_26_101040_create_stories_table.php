...
class CreateStoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stories', function (Blueprint $table) {
            ...
            $table->string('slogn', 100)->nullable();
            ...
            $table->string('story1', 1000)->nullable();
            $table->string('story2', 1000)->nullable();
            $table->string('story3', 1000)->nullable();
            $table->string('story4', 1000)->nullable();
            $table->string('story5', 1000)->nullable();
            $table->string('story6', 1000)->nullable();
            $table->string('story7', 1000)->nullable();
            $table->string('story8', 1000)->nullable();
            $table->string('story9', 1000)->nullable();
            $table->string('story10', 1000)->nullable();
            $table->string('thinking', 100)->nullable();
            $table->string('touching', 100)->nullable();
            $table->string('treating', 100)->nullable();
