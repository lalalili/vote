        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="active">
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 基本設定<span class="fa arrow"></span></a>
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 員工管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 投票管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('admin/votes') }}"> 列表</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
