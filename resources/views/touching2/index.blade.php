...
<div id="navbar-main">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                {{--<span class="icon icon-menu" style="font-size:30px; color:#3498db;">目錄</span>--}}
                {{--</button>--}}
                {{--<a class="navbar-brand hidden-xs hidden-sm" href="#home"><span class="icon icon-menu"--}}
    ...
    <div class="container" id="team" name="team">
        ...
        <div class="row white centered">
            ...
            <div class="col-lg-3 centered">
                <img class="img img-circle" src="{{ url('/touching/img/team/team01.jpg') }}" height="120px"
                     width="120px"
                     alt="">
                <br>
            ...
            <div class="col-lg-3 centered') }}">
                <img class="img img-circle" src="{{ url('/touching/img/team/team02.jpg') }}" height="120px"
                     width="120px"
                     alt="">
                <br>
            ...
            <div class="col-lg-3 centered">
                <img class="img img-circle" src="{{ url('/touching/img/team/team03.jpg') }}" height="120px"
                     width="120px"
                     alt="">
                <br>
            ...
            <div class="col-lg-3 centered">
                <img class="img img-circle" src="{{ url('/touching/img/team/team04.jpg') }}" height="120px"
                     width="120px"
                     alt="">
                <br>
    ...
    <section class="section-divider textdivider divider3">
        <div class="container">
            ...
            <hr>
            <p>From the purely practical to the richly philosophical, design is the solution to a host of
                challenges.</p>
        </div><!-- container -->
    </section><!-- section -->
            ...
            <div class="col-lg-6 blog-bg">
                ...
                <div class="col-lg-8 blog-content">
                    ...
                    <p>Armed with insight, we embark on designing the right brand experience that engages the audience.
                        It
                        encompasses both the strategic direction and creative execution that solves a business problem
                        and
